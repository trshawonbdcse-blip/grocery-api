...
# EXPANDED RIMI BALTIC CATEGORIES
STORES_CONFIG = {
    "Rimi Baltic": [
        ...
        ("Kala ja mereannid", "https://www.rimi.ee/epood/ee/tooted/kala-ja-mereannid/c/SH-4"),
        ("Joogid", "https://www.rimi.ee/epood/ee/tooted/joogid/c/SH-5"),
        ("Kauasäilivad toidukaubad", "https://www.rimi.ee/epood/ee/tooted/kauasailivad-toidukaubad/c/SH-6"),
        ("Külmutatud tooted", "https://www.rimi.ee/epood/ee/tooted/kulmutatud-tooted/c/SH-7"),
        ("Valmistoit", "https://www.rimi.ee/epood/ee/tooted/valmistoit/c/SH-8"),
        ("Maiustused ja snäkid", "https://www.rimi.ee/epood/ee/tooted/maiustused-ja-snakid/c/SH-9"),
        ("Kastmed ja õlid", "https://www.rimi.ee/epood/ee/tooted/kastmed-ja-olid/c/SH-10"),
        ("Maailma köök ja vürtsid", "https://www.rimi.ee/epood/ee/tooted/maailma-kook-ja-vurtsid/c/SH-11"),
        ("Vegantooted", "https://www.rimi.ee/epood/ee/tooted/vegantooted/c/SH-14"),
        ("Puuviljad ja köögiviljad", "https://www.rimi.ee/epood/ee/tooted/puuviljad-ja-koogiviljad/c/SH-15"),
    ]
}

MAX_PAGES = 25  # Set max page depth per category
...
async def scrape_rimi(page, categories):
    for cat_name, base_url in categories:
        ...
        for page_num in range(1, MAX_PAGES + 1):
            # Append ?page=N to traverse pagination
            ...
            try:
                ...
                # Click cookie banner on initial load
                if page_num == 1:
                    try:
                ...
                # Scroll to load dynamic card content
                await page.mouse.wheel(0, 3000)
                await page.wait_for_timeout(1500)

                # Target the main product grid
                cards = await page.query_selector_all(
                    "main .product-grid .product-grid__item, div[class*='product-grid'] .product-grid__item"
                )

                if not cards:
                    print(f"   ℹ️ End of category reached at page {page_num - 1}.")
                    break

                print(f"   Found {len(cards)} items on page {page_num}")
                ...
                print(f"⚠️ Rimi crawl error on '{cat_name}' page {page_num}: {e}")
                break
